...
class Metaclass_Fvel_Request(type):
    """Metaclass of message 'Fvel_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fvel__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fvel__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fvel__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fvel__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fvel__request
...
class Fvel_Request(metaclass=Metaclass_Fvel_Request):
    """Message class 'Fvel_Request'."""
...
class Metaclass_Fvel_Response(type):
    """Metaclass of message 'Fvel_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fvel__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fvel__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fvel__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fvel__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fvel__response
...
class Fvel_Response(metaclass=Metaclass_Fvel_Response):
    """Message class 'Fvel_Response'."""
...
class Metaclass_Fvel(type):
    """Metaclass of service 'Fvel'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ikinterface.srv.Fvel')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__fvel

            from ikinterface.srv import _fvel
            if _fvel.Metaclass_Fvel_Request._TYPE_SUPPORT is None:
                _fvel.Metaclass_Fvel_Request.__import_type_support__()
            if _fvel.Metaclass_Fvel_Response._TYPE_SUPPORT is None:
                _fvel.Metaclass_Fvel_Response.__import_type_support__()


class Fvel(metaclass=Metaclass_Fvel):
    from ikinterface.srv._fvel import Fvel_Request as Request
    from ikinterface.srv._fvel import Fvel_Response as Response
