...
#include "ikinterface/srv/detail/ref__type_support.h"
...
static const _Ref_Request_type_support_symbol_names_t _Ref_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ikinterface, srv, Ref_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ikinterface, srv, Ref_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ikinterface, srv, Ref_Request)() {
  return &::ikinterface::srv::rosidl_typesupport_c::Ref_Request_message_type_support_handle;
}
...
static const _Ref_Response_type_support_symbol_names_t _Ref_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ikinterface, srv, Ref_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ikinterface, srv, Ref_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ikinterface, srv, Ref_Response)() {
  return &::ikinterface::srv::rosidl_typesupport_c::Ref_Response_message_type_support_handle;
}
...
static const _Ref_type_support_symbol_names_t _Ref_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ikinterface, srv, Ref)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ikinterface, srv, Ref)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ikinterface, srv, Ref)() {
  return &::ikinterface::srv::rosidl_typesupport_c::Ref_service_type_support_handle;
}
