...
#ifndef IKINTERFACE__SRV__DETAIL__FVEL__FUNCTIONS_H_
#define IKINTERFACE__SRV__DETAIL__FVEL__FUNCTIONS_H_
...
/// Create srv/Fvel message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ikinterface__srv__Fvel_Request__init().
...
/// Destroy srv/Fvel message.
/**
 * It calls
 * ikinterface__srv__Fvel_Request__fini()
...
/// Check for srv/Fvel message equality.
/**
...
/// Initialize array of srv/Fvel messages.
/**
...
/// Finalize array of srv/Fvel messages.
/**
 * It calls
 * ikinterface__srv__Fvel_Request__fini()
...
/// Create array of srv/Fvel messages.
/**
 * It allocates the memory for the array and calls
 * ikinterface__srv__Fvel_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Fvel messages.
/**
 * It calls
 * ikinterface__srv__Fvel_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Fvel message array equality.
/**
...
/// Copy an array of srv/Fvel messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ikinterface__srv__Fvel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ikinterface
...
/**
 * It calls
 * ikinterface__srv__Fvel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ikinterface
...
/**
 * It allocates the memory for the array and calls
 * ikinterface__srv__Fvel_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ikinterface
...
/**
 * It calls
 * ikinterface__srv__Fvel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IKINTERFACE__SRV__DETAIL__FVEL__FUNCTIONS_H_
